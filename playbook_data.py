...
INVESTIGATIVE_QUESTIONS = [{'id': 'deadbox_user_control',
  'question': 'Who may have used or controlled this Windows laptop?',
  'situations': ['Dead-box laptop exam', 'Shared device or shared account'],
  'look_at': ['User profiles and account names',
              'Logon/session artifacts',
              'Recent file and application activity',
              'Browser profiles and signed-in accounts',
              'Possession, location, or admission context',
              'Remote-access, automation, or shared-credential alternatives'],
  'mindset': 'Treat control as a context-building question. Look for patterns across profiles, '
             'sessions, activity, possession, passwords, admissions, and alternative access paths.',
  'guardrails': ['A Windows account name is not automatically a human actor.',
                 'A profile folder can support context but does not prove physical presence.',
                 'Shared accounts, remote access, and automation should be considered when '
                 'attribution matters.'],
  'related_artifact_ids': ['windows_logon_sessions',
                           'windows_file_access',
                           'browser_activity',
                           'windows_execution',
                           'remote_access_automation'],
  'related_artifacts': ['Windows - Logon, account, and session indicators',
                        'Windows - File access and user activity indicators',
                        'Browser - Browser activity indicators']},
 {'id': 'deadbox_file_interaction',
  'question': 'Was a file opened, viewed, deleted, moved, or otherwise interacted with?',
  'situations': ['Dead-box laptop exam',
                 'File movement question',
                 'Shared device or shared account'],
  'look_at': ['LNK and Jump Lists',
              'RecentDocs/MRU and application recent lists',
              'Shellbags and folder interaction',
              'Recycle Bin and file-system metadata',
              'Source file presence or absence',
              'Cloud sync or removable-media paths'],
  'mindset': 'Separate file existence from file interaction. Then look for multiple activity '
             'traces that may support opening, viewing, moving, deletion, or access from a '
             'specific profile.',
  'guardrails': ['Recent-file artifacts can be created by previews, sync, indexing, or application '
                 'behavior.',
                 'Deletion is not automatically concealment or intent.',
                 'File movement usually requires correlation across more than one artifact '
                 'family.'],
  'related_artifact_ids': ['windows_file_access',
                           'file_system_metadata',
                           'external_media_file_movement',
                           'cloud_sync'],
  'related_artifacts': ['Windows - File access and user activity indicators',
                        'File System - File system metadata, deletion, and recycle context']},
 {'id': 'deadbox_program_execution',
  ...
  'situations': ['Dead-box laptop exam',
                 ...
                 'Shared device or shared account'],
  'look_at': ['Prefetch, when enabled',
              'Amcache/ShimCache-style artifacts',
              'UserAssist and application activity artifacts',
              'Windows Event Logs',
              'PowerShell/script logs',
              'Scheduled task and service artifacts',
              'Remote access tool artifacts'],
  'mindset': 'Look for execution-supporting artifacts, then evaluate whether they show execution, '
             'inventory, user interaction, or only presence. Actor attribution needs separate '
             'context.',
  'guardrails': ['Program presence is not execution.',
                 'Execution indicators do not identify who ran the program by themselves.',
                 'Command/script activity can come from automation, admin activity, malware, or '
                 'remote access.'],
  'related_artifact_ids': ['windows_execution',
                           'windows_event_logs',
                           'remote_access_automation',
                           'windows_logon_sessions'],
  'related_artifacts': ['Windows - Program execution indicators',
                        'Remote Access / Automation - remote access, automation, and scheduled '
                        'activity indicators']},
 {'id': 'deadbox_browser_download',
  'question': 'Was there browser, search, download, or web-app activity relevant to the question?',
  'situations': ['Dead-box laptop exam',
                 'Browser/download review',
                 'Shared device or shared account'],
  'look_at': ['Browser profile and signed-in account context',
              'History and downloads databases',
              'Search/form history where available',
              'Cookies, sessions, cache, and local storage',
              'Downloaded file path and Zone.Identifier',
              'File-open artifacts after download'],
  'mindset': 'Separate browsing, downloading, opening, account use, and user intent. They are '
             'related but not identical conclusions.',
  'guardrails': ['Browser records can result from redirects, embedded content, sync, or previews.',
                 'A download record does not prove the file was opened or understood.',
                 'Browser profile context matters for attribution.'],
  'related_artifact_ids': ['browser_activity',
                           'windows_file_access',
                           'cloud_sync',
                           'file_system_metadata'],
  'related_artifacts': ['Browser - Browser activity indicators',
                        'Windows - File access and user activity indicators']},
 {'id': 'live_volatile_priority',
  ...
  'look_at': ['Authority and scope for live collection',
              'Visible power, lock, and login state',
              'Running processes and network connections',
              'Mounted volumes and open files',
              'Encryption indicators',
              'RAM capture opportunity',
              'Risk of remote change or data loss'],
  'mindset': 'This is an order-of-volatility and risk decision. Document first, then decide '
             'whether live collection is justified and authorized before shutdown or isolation '
             'changes destroy state.',
  'guardrails': ['Live collection changes the system and must be documented.',
                 'Order of volatility does not override scope, safety, or agency policy.',
                 'Powering down may lose RAM, mounted encrypted volumes, sessions, and network '
                 'context.'],
  'related_artifact_ids': ['memory_processes',
                           'encryption_live_state',
                           'windows_logon_sessions',
                           'remote_access_automation'],
  'related_artifacts': ['Memory / RAM - Processes, command lines, and network context',
                        'Encryption / Live State - BitLocker, mounted volumes, and '
                        'encryption-related volatile context']},
 {'id': 'bitlocker_ram_key_context',
  'question': 'Could BitLocker or mounted encryption make RAM/live collection important?',
  'situations': ['BitLocker-enabled laptop',
                 'Powered-on computer / live system',
                 'Memory/RAM review'],
  'look_at': ['Whether volumes are mounted or unlocked',
              'Logged-in or locked state',
              'BitLocker status indicators where authorized',
              'RAM capture feasibility',
              'Tool/policy support',
              'Destination storage and hash documentation'],
  'mindset': 'A powered-on encrypted system may expose access and context that disappears at '
             'shutdown. RAM may contain useful encryption-related material, but that possibility '
             'must not be overstated before examination.',
  'guardrails': ['Do not claim a recovery key is in RAM unless observed and corroborated.',
                 'Do not run commands outside authority just because the system is live.',
                 'Document why live collection was or was not attempted.'],
  'related_artifact_ids': ['encryption_live_state', 'memory_processes', 'windows_logon_sessions'],
  'related_artifacts': ['Encryption / Live State - BitLocker, mounted volumes, and '
                        'encryption-related volatile context',
                        'Memory / RAM - Processes, command lines, and network context']},
 {'id': 'memory_process_network_question',
  ...
  'look_at': ['Process list/tree',
              'Command lines',
              'Network connections',
              'Handles and loaded modules',
              'Suspicious process relationships',
              'Corroborating disk/log artifacts',
              'Memory image acquisition context'],
  'mindset': 'RAM can show live system context, but memory plugin output is a lead that needs '
             'careful source, plugin, timestamp, and corroboration notes.',
  'guardrails': ['A process name by itself is not a malware conclusion.',
                 'An IP address is not attribution.',
                 'Command lines in memory do not identify the human actor by themselves.'],
  'related_artifact_ids': ['memory_processes',
                           'windows_execution',
                           'remote_access_automation',
                           'encryption_live_state'],
 ...
 {'id': 'mobile_messages_context',
  ...
  'look_at': ['Messages and attachments',
              'Calls and contacts',
              'Photos and videos',
              'App databases',
  ...
  'mindset': 'Start from the extraction type and app support, then connect relevant mobile '
             'artifacts to the question without jumping from device activity to human actor '
             'identity.',
  'guardrails': ['A message artifact does not prove who physically held the phone.',
                 'Contact names and app labels may be user-entered, synced, stale, or misleading.',
                 'Deleted/recovered artifacts require careful source and status explanation.'],
  'related_artifact_ids': ['mobile_messages_media', 'mobile_extraction_limits'],
  'related_artifacts': ['Mobile - Messages, calls, media, app, and account context',
                        'Mobile - Mobile extraction type and limitation indicators']},
 {'id': 'mobile_location_media_question',
  'question': 'What mobile artifacts may support location, movement, or media-context review?',
  'situations': ['Mobile device review'],
  'look_at': ['Photo/video metadata',
              'Location databases',
              'Maps or transportation app artifacts',
              'Wi-Fi/cell/network context',
              'Cloud media sync',
              'Timestamp/time zone and precision'],
  'mindset': 'Location and media artifacts can provide context, but source, precision, sync '
             'behavior, and device/account control must be documented before drawing stronger '
             'conclusions.',
  'guardrails': ["Device location is not automatically a person's location.",
                 'Location precision and source vary widely.',
                 'Cloud sync and shared accounts can complicate origin and possession.'],
  'related_artifact_ids': ['mobile_location_media',
                           'mobile_messages_media',
                           'mobile_extraction_limits'],
  'related_artifacts': ['Mobile - Mobile location, media metadata, and movement context']},
 {'id': 'mobile_extraction_limits_question',
  'question': 'What should be checked before explaining what a mobile extraction does or does not '
              'show?',
  'situations': ['Mobile device review'],
  'look_at': ['Extraction type',
              'Tool/version',
              'Device model and OS',
              'Lock state',
              'Unsupported apps',
              'Cloud/account scope',
              'Tool logs and partial extraction warnings'],
  'mindset': 'Before interpreting absence or presence, understand how the data was acquired and '
             'what the tool says it could not collect or parse.',
  'guardrails': ['Absence of a parsed artifact is not always absence from the device.',
                 'Tool support changes by OS, device state, and tool version.',
                 'Cloud data may require separate authority and collection.'],
 ...
 {'id': 'mobile_cloud_boundary',
  'question': 'Is the mobile result local device data, cloud-synced data, or provider/account '
              'data?',
  'situations': ['Mobile device review', 'Cloud sync review'],
  'look_at': ['Extraction report source and acquisition type',
              'Cloud/account scope notes',
              'Provider returns when authorized',
              'Local app cache and sync state',
              'Account identifiers and time range',
              'Tool warnings about cloud or unsupported data'],
  'mindset': 'Keep device, synced, and provider/account data separated before comparing them. Each '
             'source may have different authority, time range, and limitations.',
  'guardrails': ['Device authority may not include all cloud account content.',
                 'Synced app data does not automatically prove local creation or viewing.',
                 'Provider records and local device artifacts can use different timestamp '
                 'meanings.'],
  'related_artifact_ids': ['mobile_extraction_limits', 'mobile_messages_media', 'cloud_sync'],
  'related_artifacts': ['Mobile - Mobile extraction type and limitation indicators',
                        'Cloud / Sync - Cloud sync and local cloud-client indicators']},
 {'id': 'external_media_connected',
  ...
  'look_at': ['USBSTOR and mounted device artifacts',
              'SetupAPI logs',
              'Event logs',
              'Volume serial and drive letter context',
              'User association indicators',
              'Connection timeline'],
  'mindset': 'First establish device connection context, then separately evaluate file movement, '
             'user association, and timing.',
  'guardrails': ['Connection does not prove file transfer.',
                 'Connection does not identify the person who connected it.',
                 'Device identifiers and drive letters can be ambiguous without correlation.'],
  'related_artifact_ids': ['usb_devices', 'external_media_file_movement', 'windows_logon_sessions'],
  'related_artifacts': ['Windows - USB / external device connection indicators',
                        'External Media - External media file movement indicators']},
 {'id': 'external_media_file_transfer',
  ...
  'look_at': ['Removable-path LNK/Jump Lists',
              'Shellbags',
              'Recent files',
              'File system timestamps',
              'USB connection context',
              'Application logs',
              'Source/destination file presence'],
  'mindset': 'Treat file transfer as a correlation question. Build a timeline using device '
             'connection, file activity, source/destination paths, and user/session context.',
  'guardrails': ['Opening a file from USB is not the same as copying it.',
                 'Timestamp patterns can be suggestive but may have benign explanations.',
                 'Avoid saying transfer occurred unless supporting artifacts align.'],
  'related_artifact_ids': ['external_media_file_movement',
                           'usb_devices',
                           'windows_file_access',
                           'file_system_metadata'],
  'related_artifacts': ['External Media - External media file movement indicators',
                        'Windows - USB / external device connection indicators']},
 {'id': 'cloud_sync_source',
  'question': 'Is this local activity, cloud-synced activity, or both?',
  'situations': ['Cloud sync review',
                 'Browser/download review',
                 'Mobile device review',
                 'Dead-box laptop exam'],
  'look_at': ['Cloud client folders',
              'Sync logs/metadata',
              'Placeholder or hydration state',
              'Cloud account identifiers',
              'Browser web-app activity',
              'Provider exports where authorized',
              'Local file-open artifacts'],
  'mindset': 'Identify the source of the data before interpreting it. A synced artifact may '
             'reflect another device, web account, or cloud service rather than only local user '
             'activity.',
  'guardrails': ['Cloud authority may be separate from device authority.',
                 'A synced file does not automatically prove local creation or viewing.',
                 'Multi-device accounts complicate attribution and timing.'],
  'related_artifact_ids': ['cloud_sync',
                           'browser_activity',
                           'windows_file_access',
                           'mobile_extraction_limits'],
  'related_artifacts': ['Cloud / Sync - Cloud sync and local cloud-client indicators']},
 {'id': 'remote_or_automation_context',
  'question': 'Could remote access, automation, scripts, or scheduled activity explain what '
              'happened?',
  'situations': ['Possible remote access or automation',
                 'Powered-on computer / live system',
                 'Dead-box laptop exam',
                 'Shared device or shared account'],
  'look_at': ['RDP/remote access logs',
              'Remote access apps',
              'PowerShell logs',
              'Scheduled Tasks',
              ...
              'Network connections',
              'Security/EDR logs'],
  'mindset': 'When actor attribution matters, look for alternative mechanisms that can create '
             'activity without the account holder physically typing at the keyboard.',
  'guardrails': ['Remote access can make activity appear local without corroborating context.',
                 'Scheduled tasks and scripts can run without active human input.',
                 'Tool presence alone is not unauthorized use or malware.'],
  'related_artifact_ids': ['remote_access_automation',
                           'windows_event_logs',
                           'memory_processes',
                           'windows_execution'],
  'related_artifacts': ['Remote Access / Automation - Remote access, automation, and scheduled '
                        'activity indicators']}]
